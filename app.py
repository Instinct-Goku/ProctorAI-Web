...
htmlbody='''
Your account on <b>Proctor AI</b> Quiz App was successfully created.
Please click the link below to confirm your email address and
activate your account:
  
<b><a href="{{ confirm_url }}">{{ confirm_url }}</a><b>
 <p>
--
...
client = Client('enter email api key here')
...
def send_confirmation_email(user_email):
	...
	x = ""
	x=confirm_url.split("http://192.168.0.106:5000")
